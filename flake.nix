        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              ...
              echo ""
              echo "🚀 AWChat development environment ready (Android 17 / API 37)"
              echo "   • Java:   $(java -version 2>&1 | head -1)"
              echo "   • ANDROID_HOME: $ANDROID_HOME"
              echo ""
              echo "Common commands (Justfile recommended):"
              echo "  just build            # Debug APK"
              echo "  just install          # Debug + install on device"
              echo "  just release          # Release AAB + signed APK"
              echo "  just test"
              echo ""
              echo "  adb devices"
