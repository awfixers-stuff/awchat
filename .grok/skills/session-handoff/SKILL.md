...
`.grok/hooks/agents-continuity.json` also syncs on `Stop`, `SessionEnd`, and `SubagentStop` when there are local file changes. Trust this repo in `~/.grok/trusted-hook-projects`.
